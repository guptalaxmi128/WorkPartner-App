  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop:4}}>
        ...
        <Text style={{fontFamily:'Poppins',fontSize:14,fontWeight:700,width:95,height:20}}>SALE IS LIVE</Text>
        ...
        <Text style={{width:54,height:15,fontFamily:'Poppins',fontSize:11,fontWeight:500}}>1 min ago</Text>
        </View>
        </View>
      ...
      <View style={{marginTop:4}}>
        ...
        <Text style={{width:54,height:16,fontFamily:'Poppins',fontSize:11,fontWeight:500}}>1 min ago</Text>
        </View>
        </View>
      </View>
      <View style={styles.hr} />
      ...
      <View style={{marginTop:4}}>
        ...
        <Text style={{width:80,height:15,fontFamily:'Poppins',fontSize:11,fontWeight:500}}>10 Hrs ago</Text>
        </View>
        </View>
      </View>
      <View style={styles.hr} />
